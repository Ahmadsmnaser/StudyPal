...
load_dotenv()
DEVICE = os.getenv("device", "cpu") # default cpu 

working_dir = os.path.dirname(os.path.abspath(__file__))
parent_dir = os.path.dirname(working_dir)

subjects_list = ["Operating_System"]

def get_vector_db_path(chapter, subject):
    if chapter == "All Chapters":
        return f"{working_dir}/vector_db/{subject.lower()}_vector_db"
    return f"{working_dir}/vector_db/chapters_vector_db/{chapter}"
